...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        darkModeRadioButton->setGeometry(QRect(470, 447, 81, 16));
        ...
        lightModeRadioButton->setGeometry(QRect(470, 467, 91, 21));
