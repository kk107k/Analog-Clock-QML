...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        digitalDisplayLabel->setStyleSheet(QString::fromUtf8("QLabel {\n"
"   background-color: rgba(255, 255, 255, 127); }"));
        ...
        toggle24HourModeButton->setGeometry(QRect(425, 415, 41, 41));
...
""));
        ...
        toggleDashLinesButton->setGeometry(QRect(10, 390, 41, 41));
...
""));
        ...
        toggleMinuteHandButton->setGeometry(QRect(425, 15, 41, 41));
...
""));
        ...
        toggleHourHandButton->setGeometry(QRect(10, 15, 41, 41));
...
""));
        ...
        hourHandSlider->setGeometry(QRect(15, 460, 331, 16));
        ...
        minuteHandSlider->setGeometry(QRect(15, 490, 331, 16));
        ...
        HourHandSliderLabel->setGeometry(QRect(20, 475, 326, 16));
        QFont font1;
        font1.setPointSize(7);
        HourHandSliderLabel->setFont(font1);
        HourHandSliderLabel->setAlignment(Qt::AlignCenter);
        minuteHandSliderLabel = new QLabel(centralwidget);
        minuteHandSliderLabel->setObjectName("minuteHandSliderLabel");
        minuteHandSliderLabel->setGeometry(QRect(20, 505, 326, 16));
        minuteHandSliderLabel->setFont(font1);
        minuteHandSliderLabel->setAlignment(Qt::AlignCenter);
        toggleSecondHandButton = new QPushButton(centralwidget);
        toggleSecondHandButton->setObjectName("toggleSecondHandButton");
        toggleSecondHandButton->setGeometry(QRect(380, 460, 41, 41));
...
""));
        ...
        toggleManualTimeButton->setGeometry(QRect(425, 460, 41, 41));
        QFont font2;
        font2.setBold(true);
        font2.setItalic(false);
        toggleManualTimeButton->setFont(font2);
...
""));
        ...
        blackModeButton->setGeometry(QRect(10, 435, 16, 16));
        QPalette palette;
...
"}"));
        ...
        blueModeButton->setGeometry(QRect(30, 435, 16, 16));
        QPalette palette1;
...
"  background-color: #1976D2;}"));
        ...
        orangeModeButton->setGeometry(QRect(50, 435, 16, 16));
        QPalette palette2;
...
"  background-color: #FF5722;}"));
        ...
        greenModeButton->setGeometry(QRect(70, 435, 16, 16));
        QPalette palette3;
...
"  background-color: #388E3C;}"));
        ...
        dashLineLabel->setGeometry(QRect(40, 400, 71, 21));
        ...
        digitalLabel->setGeometry(QRect(390, 390, 36, 21));
        ...
        hourHandLabel->setGeometry(QRect(40, 25, 71, 21));
        ...
        toggleDigitalButton->setGeometry(QRect(425, 370, 41, 41));
...
""));
        ...
        toggle12HourModeButton->setGeometry(QRect(380, 415, 41, 41));
...
""));
        ...
        hourHandLabel_2->setGeometry(QRect(355, 25, 81, 21));
        ...
        hourHandLabel_3->setGeometry(QRect(370, 500, 61, 21));
